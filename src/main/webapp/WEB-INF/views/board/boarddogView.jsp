 ...
 <div class="main-content">
	<div class="container">
		<table width="800px" height="150px" border="0" cellspacing="0" cellpagging="0" align="center">
			...
			<tr>
				<td>등록날짜</td>
				<td>${board3.regdate3}</td>
			</tr>
			<tr><!--글목록보기에 출력  -->
				<td>첨부파일</td>
				<td><a href="file3?filename=${board3.filename3}">${board3.filename3 }</a></td>
			</tr>
			</table>
			</div>
			<table  width="800px" height="300px" border="0" cellspacing="0" cellpagging="0" align="center">
			<tr>
				<td align="right" colspan="2">
					<input class="recharge-button" type="button" value="수정" 
					   onclick="location.href='update3?seq3=${board3.seq3}'">
					   
					<input class="recharge-button" type="button" value="삭제" 
					   onclick="location.href='delete3?seq3=${board3.seq3}'">
					   
					<input class="recharge-button" type="button" value="목록" onclick="location.href='list3'">
				</td>
			</tr>
			</table>
