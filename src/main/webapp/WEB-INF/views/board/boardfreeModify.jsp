...
<tr valign="middle" bgcolor="#ffffff"><td>
 <div class="main-content">
	<div class="container">
		...
		<form action="write2" enctype="multipart/form-data" method="post">
		    <div class="form-group">
		        <label for="title2">제목</label>
		        <input type="text" id="title2" name="title2" value="${command.title2}">
		    </div>
		    <div class="form-group">
		        <label for="writer2">작성자</label>
		        <input type="text" id="writer2" name="writer2" value="${command.writer2}">
		    </div>
		    <div class="form-group">
		        <label for="pwd2">비밀번호</label>
		        <input type="password" id="pw2d" name="pwd2">
		    </div>
		    <div class="form-group">
		        <label for="content2">내용</label>
		        <textarea rows="10" cols="50" id="content2" name="content2"></textarea>
		    </div>
		    <div class="form-group">
		        <label for="upload">파일업로드</label>
		        <input type="file" id="upload" name="upload2">
		    </div>
		    <div class="form-buttons">
		        <input class="recharge-button" type="submit" value="저장">
		        <input class="recharge-button" type="button" value="목록" onclick="location.href='list2.do'">
		    </div>
		</form>
	</div>
</div>		
