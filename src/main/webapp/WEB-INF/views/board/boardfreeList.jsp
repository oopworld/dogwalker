<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
	<%@ page import="com.dogwalker.domain.BoardfreeVO" %>
	...
	<div class="container">
		<div class="jusc">
				...
				<tbody class="table-group-divider">
					...
					<c:forEach var="article2" items="${list2}">
						<tr>
							...
							<td><a href="detail2.do?seq2=${article2.seq2}">${article2.title2}</a></td>
			...
			<form action="list2" name="search" method="get" onsubmit="return searchCheck()">
				...
				<input class="recharge-button form-buttons"  type = "button" value="글쓰기" onclick="location.href='write2'">
		</div>
	  </div>
	</div>
		</td></tr>
