	...
	<div class="container">
		...
		<form action="write2" enctype="multipart/form-data" method="post">
		    <div class="form-group">
		        ...
		        <input type="text" id="title" name="title2" value="${command2.title2}">
		    </div>
		    <div class="form-group">
		        <label for="writer">작성자</label>
		        <input type="text" id="writer" name="writer2" value="${command2.writer2}">
		    </div>
		    <div class="form-group">
		    ...
		    <div class="form-group">
		        ...
		        <textarea rows="10" cols="50" id="content" name="content2"></textarea>
		    </div>
		    <div class="form-group">
