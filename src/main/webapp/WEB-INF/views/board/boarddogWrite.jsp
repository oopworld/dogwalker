...
<tr valign="middle" bgcolor="#ffffff"><td>
 <div class="main-content">
	<div class="container">
		...
		<form action="write3" enctype="multipart/form-data" method="post">
		    <div class="form-group">
		        <label for="title3">제목</label>
		        <input type="text" id="title" name="title3" value="${command3.title3}">
		    </div>
		    <div class="form-group">
		        <label for="writer3">작성자</label>
		        <input type="text" id="writer" name="writer3" value="${command3.writer3}">
		    </div>
		    <div class="form-group">
		        <label for="pwd3">비밀번호</label>
		        <input type="password" id="pwd" name="pwd3">
		    </div>
		    <div class="form-group">
		        <label for="content3">내용</label>
		        <textarea rows="10" cols="50" id="content" name="content3"></textarea>
		    </div>
		    <div class="form-group">
		        <label for="upload3">파일업로드</label>
		        <input type="file" id="upload" name="upload3">
		    </div>
		    <div class="form-buttons">
		        <input class="recharge-button" type="submit" value="저장">
		        <input class="recharge-button" type="button" value="목록" onclick="location.href='list3.do'">
		    </div>
		</form>
	</div>
</div>		
