...
<tr valign="middle" bgcolor="#ffffff"><td>
	...
	<div class="container text-center border border-2 cm-1">
		...
		<p>
			...
			<div class="row">
			<div class="col-2"></div>
				<div class="col-4"><button type="button" class="btn btn-primary" onclick ="location.href = 'startWalk' ">산책시작</button></div>
				<div class="col-4">
					<!-- 모달 시작 -->
			...
			<p>
			<div class="col-2"></div>
				<div class="col-4"><p>산책 시작시간 10분뒤까지 산책시작 버튼이 <br> 눌리지 않을 경우 산책이 자동 취소됩니다.</div>
