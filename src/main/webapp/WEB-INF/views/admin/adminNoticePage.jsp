	...
	.recharge-button.form-buttons {
		...
		<div class="container">
				...
				<div class="jusc">			
					...
					<h1 style="text-align:center; margin-bottom:40px;">공지사항</h1>
						...
						<tbody class="table-group-divider">
							...
							<c:forEach var="article" items="${noticeList}">
								<tr>
									...
									<td><a href="NotView.do?seq=${article.seq}">${article.title}</a></td>
									<td>${article.writer}</td>
									<td>${article.regdate}</td>
									<td>${article.hit}</td>
									<td>
									<input class="recharge-button" type="button" value="삭제" onclick="location.href='delete21?seq=${article.seq}'">
					...
					<form action="list" name="search" method="get" onsubmit="return searchCheck()">
						...
						<input class="recharge-button form-buttons" type="button" value="글쓰기" onclick="location.href='/admin/admin_NotWrite'">
