	...
	.recharge-button.form-buttons {
		...
		<div class="container">
				...
				<div class="jusc">			
					...
					<h1 style="text-align:center; margin-bottom:40px;">자유게시판</h1>
						...
						<tbody class="table-group-divider">
							...
							<c:forEach var="article2" items="${noticeList2}">
								<tr>
									<td align="center">${article2.seq2}</td>
									<td><a href="NotView2.do?seq2=${article2.seq2}">${article2.title2}</a></td>
									<td>${article2.writer2}</td>
									<td>${article2.regdate2}</td>
									<td>${article2.hit2}</td>
									<td>
									<input class="recharge-button" type="button" value="삭제" onclick="location.href='delete24?seq2=${article2.seq2}'">
								...
								<tr>
									<td align="center">
										<select name="keyField">
											...
											<option value="writer2">이름</option>
											<option value="content2">내용</option>
