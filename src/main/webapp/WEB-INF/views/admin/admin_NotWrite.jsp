...
<!-- Modal -->
		...
		<div class="main-content">
			<div class="container">
		        ...
		        <form action="admin_NotWrite" enctype="multipart/form-data" method="post">
            ...
            <div class="form-buttons">
                ...
                <input class="recharge-button" type="button" value="목록" onclick="location.href='/admin/adminNoticePage'">
            </div>
        </form>
    </div>
</div>
